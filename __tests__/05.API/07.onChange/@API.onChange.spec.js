...
describe('API: Check onChange method call', () => {
  ...
  test('A new value must be set', () => {
        expect(instance.get('config1.div13.v_string')).equals('new value');
  });

  test('The onChange method should not be triggered when a failure to set a new value', () => {
  ...
  test('The onChange method should not be triggered when the onChange = false parameter is passed in the options', () => {
    const paramPath = 'config1.div13.v_email';
