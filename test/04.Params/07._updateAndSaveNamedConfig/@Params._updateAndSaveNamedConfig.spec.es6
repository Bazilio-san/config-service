...
const newConfig = require('./new-config1.es6');

const configFile = `${Params.getConfigDir()}/${configName}.json`;
const expected = require('./expected-ansver-without-refresh-schema.es6');
const expectedWithRefresh = require('./expected-ansver-with-refresh-schema.es6');
